...
void oswaprow_avx(uint8_t *restrict a, size_t i, size_t j, size_t k) {
  if (i == j)
    return;
...
void oaxpy_avx(uint8_t *restrict a, uint8_t *restrict b, size_t i, size_t j, size_t k, uint8_t u) {
  octet *ap = a + (i * ALIGNED_COLS(k));
...
void oaddrow_avx(uint8_t *restrict a, uint8_t *restrict b, size_t i, size_t j, size_t k) {
  octet *ap = a + (i * ALIGNED_COLS(k));
  octet *bp = b + (j * ALIGNED_COLS(k));
...
void oscal_avx(uint8_t *restrict a, size_t i, size_t k, uint8_t u) {
  octet *ap = a + (i * ALIGNED_COLS(k));
